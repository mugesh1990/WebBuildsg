...
public class HomePageSteps extends Components
{
	...
	public void validate_the_Social_media_container_are_having_log() throws Throwable
	{
		...
		//Assert.assertEquals(homepage.SocialMediacontainerlist.size() >= count1, true);
		...
		extentReportUpdate(logger,"Home Page", driver.getTitle(), homepage.SocialMediacontainerlogs.size() >= count1, true);
	}
